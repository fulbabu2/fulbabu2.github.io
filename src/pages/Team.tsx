        ...
        <div className="people-page">
            <div className="container">
                ...
                <div className="pi-highlight">
                    <div className="member-card pi-card">
                        <Link to={piMember.link!} className="pi-link-wrapper">
                            <img
                                src={piMember.image}
                                alt={piMember.name}
                                className="member-photo pi-photo-main"
                                style={piMember.photoStyle}
                            />
                        </Link>
                        <div className="member-info pi-info">
                            <Link to={piMember.link!} className="pi-text-link">
                                <h3>{piMember.name}</h3>
                                <p className="member-role">{piMember.role}</p>
                            </Link>
                ...
                <div className="members-grid">
                    {groupMembers.map((member, index) => (
                        <div key={index} className="member-card">
                            {member.link ? (
                                <a href={member.link} className="member-card-link">
                                    {member.image ? (
                                        <img
                                            src={member.image}
                                            alt={member.name}
                                        ...
                                        <div className="member-photo-placeholder" style={member.photoStyle?.height ? { height: member.photoStyle.height } : undefined}></div>
                                    )}
                                </a>
                            ) : (
                                <>
                            ...
                            <div className="member-info">
                                {member.link ? (
                                    <a href={member.link} className="member-card-link-text">
                                        <h3>{member.name}</h3>
